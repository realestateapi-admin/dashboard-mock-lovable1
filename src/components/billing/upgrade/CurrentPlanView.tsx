...
export const CurrentPlanView = ({
  ...
  return (
    ...
    >
      <div>
        <h1 className="text-3xl font-semibold tracking-tight">Upgrade Your Subscription</h1>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          >
            <div>
              <h3 className="font-medium text-base mb-1">Change Plan Level</h3>
          ...
          >
            <div>
              <h3 className="font-medium text-base mb-1">Change Overage Settings</h3>
              <p className="text-sm text-muted-foreground">
                Update how we handle exceeding your plan limits
              </p>
            </div>
            <ArrowRight className="h-5 w-5 text-muted-foreground" />
          </Button>
