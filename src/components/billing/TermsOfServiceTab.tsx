  ...
  const handlePrint = () => {
    ...
    if (printWindow) {
      printWindow.document.write(`
        ...
        <html>
          <head>
            <title>Terms of Service - RealEstateAPI</title>
            <style>
              body { 
          ...
          <body>
            ...
            <h4>13. Service Level Agreement</h4>
