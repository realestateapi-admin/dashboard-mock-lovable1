  ...
  return (
    <div className="space-y-4">
      ...
      <RadioGroup
        ...
        required
      >
        <div className="flex items-start space-x-3 border p-4 rounded-md hover:border-purple-200 hover:bg-purple-50 transition-colors">
        ...
        <div className={`flex items-start space-x-3 border p-4 rounded-md ${isStarterPlan ? 'opacity-50' : 'hover:border-purple-200 hover:bg-purple-50 transition-colors'}`}>
          <RadioGroupItem 
            value="unlimited" 
            id="unlimited" 
            className="mt-1" 
