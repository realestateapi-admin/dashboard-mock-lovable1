...
// Custom Node Types
const ProspectNode = ({ data }: { data: { label: string } }) => (
...
const SystemNode = ({ data }: { data: { label: string, icon?: React.ReactNode } }) => (
  <div className="label-container">
    <div className="icon-container">
      {data.icon}
      <span>{data.label}</span>
...
const DatabaseNode = ({ data }: { data: { label: string } }) => (
  <div className="label-container">
    <div className="icon-container">
...
const ResultNode = ({ data }: { data: { label: string } }) => (
  <div className="label-container">{data.label}</div>
);
